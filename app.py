...
if st.session_state.logged_in_user is None:
    ...
    with tab1:
        ...
        # Renderowanie tabeli liderów w formacie HTML dla zachowania nowych kolorów akcentów KriCon
        html_rows = ""
        for idx, row in df_scores.iterrows():
            bg_style = ""
            if idx == 1 and row['Punkty'] > 0:
                # Jasnopomarańczowe tło akcentu lidera
                bg_style = 'style="background-color: #FEF3E2; font-weight: bold; color: #1E3A8A;"' 
            elif idx == len(df_scores) and row['Punkty'] > 0:
                # Pozostawiamy jasnoczerwone tło dla ostatniego
    ...
    with tab3:
        ...
        # Generowanie tabeli jako HTML dla poprawnego renderowania nowych granatowych nagłówków tabeli
        group_rows = ""
